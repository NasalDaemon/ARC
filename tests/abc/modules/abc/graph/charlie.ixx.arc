...
//template<typename T, int* const& I, double d, std::vector<int, A, "h\"i", '\n', `0 < 1`, typename A::T, typename A::T::template T, typename decltype(auto(i).c.d<int>().a)::template T<int>> vec, typename A, int... Ts, template<class> class... Templ, std::same_as<int> I, auto const volatile avc>
