...
private:
    ...
    constexpr std::size_t min_mask(std::size_t newMask) const noexcept
    {
    ...
    static constexpr std::size_t capacity_of_mask(std::size_t mask)
#ifdef NDEBUG
    noexcept
#endif
    {
    ...
    {}
#else
    ARC_INLINE static constexpr void assert_is_mask(std::size_t mask)
    {
